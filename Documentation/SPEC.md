...
**Status:** Draft for ratification — **rev 5**
...
Rev 5 is a **clarifying** revision, opened by the M1 completion audit (2026-07-25): no semantics reverse, no event kind is added or removed, no invariant weakens, and no code written against rev 4 becomes wrong. Four of the five items close gaps M2 would otherwise have had to improvise past — which is the point of auditing at a milestone boundary rather than mid-reducer.
