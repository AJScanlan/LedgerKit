...
enum Fix {
    ...
    static let genA = GenerationAttemptID(uuid(0x30))
    static let genB = GenerationAttemptID(uuid(0x31))
    static let genC = GenerationAttemptID(uuid(0x32))
    static let genGhost = GenerationAttemptID(uuid(0x3F))
